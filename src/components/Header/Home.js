          ...
          {user && <div className="home-page">
            <div className="home-page">
              ...
              <div className="home-page-message">
                <img src="Recycle.jpeg" />
                <p>Precycle is an application that allows users to find out if items are recyclable or not. Check out our features by navigating to
            ...
            to find out if your item is recyclable. The items are being updated constantly so keep checking back!</p>
              </div>
            </div>
          </div>
          }
